...
class ARC_gui_editBase
{
    ...
    colorSelection[] =
    {
            "(profilenamespARC getVariable ['GUI_BCG_RGB_R',0.3843])",
            "(profilenamespARC getVariable ['GUI_BCG_RGB_G',0.7019])",
            "(profilenamespARC getVariable ['GUI_BCG_RGB_B',0.8862])",
            1
    };
    autocomplete = "";
    text = "";
...
class RscListBox;
class ARC_gui_listBoxBase : RscListBox{
  type = CT_LISTBOX;
  style = ST_MULTI;
  font = FONT_ARC;
  sizeEx = 0.03921;
  ...
  colorDisabled[] = {"(profilenamespARC getVariable ['GUI_BCG_RGB_R',0.69])","(profilenamespARC getVariable ['GUI_BCG_RGB_G',0.75])","(profilenamespARC getVariable ['GUI_BCG_RGB_B',0.5])", 0.25};
  period = 1.2;
  rowHeight = 0.03;
...
onMouseButtonDblClick = "";
 ...
 class Task
 {
  ...
  color[] = {"(profilenamespARC getVariable ['IGUI_TEXT_RGB_R',0])","(profilenamespARC getVariable ['IGUI_TEXT_RGB_G',1])","(profilenamespARC getVariable ['IGUI_TEXT_RGB_B',1])","(profilenamespARC getVariable ['IGUI_TEXT_RGB_A',0.8])"};
