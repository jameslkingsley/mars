#define WINDOW_EDITATTRIBUTES_HAbs_MAP (safeZoneH min (100 * GRID_H))
...
class GVAR(ctrlMapWindow) {
    ...
    class ControlsBackground {
        class Background: MARS_gui_ctrlStaticBackground {
            ...
            y = QUOTE(0.5 - WINDOW_EDITATTRIBUTES_HAbs_MAP * 0.5 + 10 * GRID_H);
            w = QUOTE(100 * GRID_W);
            h = QUOTE(WINDOW_EDITATTRIBUTES_HAbs_MAP - (SIZE_M + 10) * GRID_H);
        };
        class BackgroundButtons: MARS_gui_ctrlStaticFooter {
            x = QUOTE(CENTER_X - (100 * 0.5) * GRID_W);
            y = QUOTE(0.5 + WINDOW_EDITATTRIBUTES_HAbs_MAP * 0.5 - (2 * SIZE_M + 2) * GRID_H);
            w = QUOTE(100 * GRID_W);
            h = (SIZE_M + 2) * GRID_H;
        };
        class Title: MARS_gui_ctrlStaticTitle {
            ...
            x = QUOTE(CENTER_X - (100 * 0.5) * GRID_W);
            y = QUOTE(0.5 - WINDOW_EDITATTRIBUTES_HAbs_MAP * 0.5 + SIZE_M * GRID_H);
            w = QUOTE(100 * GRID_W);
            h = SIZE_M * GRID_H;
            text = "Map Position";
            colorShadow[] = {0,0,0,0};
        ...
        class ButtonOK: MARS_gui_ctrlButtonOk {
            ...
            y = QUOTE(0.5 + WINDOW_EDITATTRIBUTES_HAbs_MAP * 0.5 - (2 * SIZE_M + 1) * GRID_H);
            w = 25 * GRID_W;
            h = SIZE_M * GRID_H;
    ...
    class Controls {
        class Map: MARS_gui_ctrlMap {
            ...
            y = QUOTE(0.5 - (WINDOW_EDITATTRIBUTES_HAbs_MAP * 0.5) + ((SIZE_M * 3) * GRID_H));
