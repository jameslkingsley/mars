...
[QGVAR(alwaysAllowLoginWhenEmpty), "CHECKBOX", "Allow login when empty", "Mars", true, true] call CBA_Settings_fnc_init;
[QGVAR(allowLoginIfCurator), "CHECKBOX", "Allow login if curator", "Mars", true, true] call CBA_Settings_fnc_init;
[QGVAR(allowLoginIfAdmin), "CHECKBOX", "Allow login if admin", "Mars", true, true] call CBA_Settings_fnc_init;
